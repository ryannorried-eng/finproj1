-- Repair: legacy DBs may have schema_version >= 8 but rec_snapshots missing
-- (e.g., older lines.db upgraded outside the normal migration path).
-- CREATE TABLE IF NOT EXISTS makes this a no-op on already-correct DBs.
